(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(["module", "exports", "../styling/StyleContext", "@smartface/styler/lib/styler", "@smartface/styler/lib/commandsManager", "@smartface/styler/lib/utils/merge", "./sfCorePropFactory", "sf-core/device/screen", "sf-core/device/", "sf-core/device/system", "../core/isTablet", "../styling/Stylable", "../core/hooks", "../core/constants", "./fromSFComponent"], factory);
		...
		factory(mod, mod.exports, global.StyleContext, global.styler, global.commandsManager, global.merge, global.sfCorePropFactory, global.screen, global.device, global.system, global.isTablet, global.Stylable, global.hooks, global.constants, global.fromSFComponent);
		global.pageContext = mod.exports;
	}
})(this, function (module, exports, _StyleContext, _styler, _commandsManager, _merge, _sfCorePropFactory, _screen, _device, _system, _isTablet, _Stylable, _hooks, _constants, _fromSFComponent) {
	"use strict";
	...
	function contextReducer(context, action, target) {
		...
		switch (action.type) {
			...
			case 'removeChildren':
				...
				break;
			case 'pushClassNames':
				context.map(function (actor, name) {
					if (name === target) {
