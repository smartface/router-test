...
const COLOR_PROPS = ["color", "backgroundColor", "textColor", "borderColor", "titleColor", "thumbOffColor", "thumbOnColor", "toggleOffColor", "toggleOnColor", "hintTextColor", "minTrackColor", "maxTrackColor", "thumbColor", "itemColor", "shadowColor", "foregroundColor", "underlineColor", "textFieldBackgroundColor", "cursorColor", "tintColor"];
...
function createImageForDevice(image) {
  ...
  if (image instanceof Object) {
    if (image.src !== undefined || image.autoMirrored !== undefined) return {
