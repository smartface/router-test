(function (global, factory) {
  ...
  function pageContextPatch(page, name) {
    ...
    page.setContextDispatcher = (0, _patchMethod2.default)(page, "setContextDispatcher", setContextDispatcher);
    ...
    function onLoad(superOnLoad) {
      ...
      page.themeContext({
        ...
        name: name,
        pageContext: (0, _pageContext2.default)(page, name, null, null)
      });
    }
