...
var _extend = _interopRequireDefault(require("js-base/core/extend"));

var _pageContext = _interopRequireDefault(require("./pageContext"));

var _patchMethod = _interopRequireDefault(require("../util/patchMethod"));
...
function onOrientationChange(superOnOrientationChange) {
  ...
  this.layout.applyLayout(); // superOnOrientationChange && setTimeout(superOnOrientationChange.bind(this),1);
...
function pageContextPatch(page, name) {
  page.onLoad = (0, _patchMethod.default)(page, "onLoad", onLoad);
  page.onShow = (0, _patchMethod.default)(page, "onShow", onShow);
  page.onHide = (0, _patchMethod.default)(page, "onHide", onHide);
  page.componentDidEnter = (0, _patchMethod.default)(page, "componentDidEnter", componentDidEnter);
  page.onOrientationChange = (0, _patchMethod.default)(page, "onOrientationChange", onOrientationChange); // hides unload logic
  ...
  function onPageUnload(superOnUnload) {
    ...
    this.themeContext(null); // pageContextPatchDispose();
  }
