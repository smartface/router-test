...
class Actor {
  ...
  constructor(component, name, id) {
    ...
    this._actorInternal_.component.set(this._actorInternal_.componentKey, component); // this._actorInternal_.component = component;
  ...
  getComponent() {
    return this._actorInternal_.component.get(this._actorInternal_.componentKey); // return this._actorInternal_.component;
  }
  ...
  componentDidEnter(dispatcher) {
    ...
    const component = this.getComponent();
    this._dispatcher = dispatcher; // let _onUnload = component.onUnload;
    // component.onUnload = () => {
    //   dispatcher({
    //     type: "unload"
    //   },
    ...
    try {
      ...
      (0, _raiseErrorMaybe.default)(e, !!this._actorInternal_ && !!component.component && component.onError);
    }
  }
