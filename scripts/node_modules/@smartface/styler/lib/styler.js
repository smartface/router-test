(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["module", "exports", "./utils/cloneStyle", "./utils/findClassNames", "./utils/flatMapStyles", "./buildStyles", "./utils/merge"], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require("./utils/cloneStyle"), require("./utils/findClassNames"), require("./utils/flatMapStyles"), require("./buildStyles"), require("./utils/merge"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.cloneStyle, global.findClassNames, global.flatMapStyles, global.buildStyles, global.merge);
    global.styler = mod.exports;
  }
})(this, function (module, exports, _cloneStyle, _findClassNames, _flatMapStyles, _buildStyles, _merge) {
  "use strict";
   ...
   */
  function styler() {
    var stylesBundle = _buildStyles2.default.apply(null, arguments);
    ...
    return function (classNames) {
      ...
      return function () {
        ...
        var copy = _merge2.default.apply(null, styles);
